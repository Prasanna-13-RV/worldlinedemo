        ...
        (e.debounce = function (a, u, v) {
          var h,
            ...
            pt = function () {
              ...
              J < u
                ? (h = setTimeout(pt, u - J))
                : ((h = null), v || ((ct = a.apply(k, q)), (k = q = null)));
            };
          return function () {
    ...
    Bt.define(
      ...
      (re.exports = function (e, y, l) {
        ...
        function I(E) {
          return E.indexOf("//") >= 0
            ? E
            : z("https://editor-api.webflow.com" + E);
        }
        function z(E) {
  ...
  var he = lt((De, le) => {
    ...
    _t.define(
      ...
      (le.exports = function (e, y) {
        ...
        function H(z) {
          var b =
            (C && z.getAttribute("href-disabled")) || z.getAttribute("href");
      ...
      (pe.exports = function (e) {
        ...
        function A(g) {
          ...
          function P(I) {
            ...
            (z && z.length > 1) ||
              ((L = !0),
              z ? ((_ = !0), (B = z[0].clientX)) : (B = I.clientX),
              (U = B));
          }
          function $(I) {
            if (L) {
